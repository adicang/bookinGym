<?php
    ...
    if (!$urlaray['adminUser'] && !$urlaray['traineeUser']){
        $post_data = array('code'=>0,'regError'=>'*אנא הזן סוג משתמש');
    }
    else if(!$urlaray['username']){
            ...
            if ($error){
                ...
                $message = '<html lang="HE">
                            ...
                            <body style="text-align:right; direction:rtl;">
                                <table>
                                    <tr>
                                        <td><h3> תודה על הצטרפותך ל bookinGym!</h3></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                    <td><b> קישור להזנת הקוד: </b> <a href="http://adica.mtacloud.co.il/reg2.php?userId='.$userId.'"> לחץ כאן על מנת להזין את קוד האישור </a> </td>
                                    </tr>
                                    <tr>
                                    <tr></tr>
                                    <tr></tr>
