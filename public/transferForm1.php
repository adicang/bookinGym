...
<header>
  ...
  <main>
      ...
      <section class="container-fluid padding text-center">
        <br><h3 class="textCenter;">המודעה נשמרה בהצלחה!</h3>
              ...
              <fieldset>
                ...
                <div id="contacts">
                  ...
                  <div class="form-group col-lg-3 text-right toRight">
                    ...
                    <input type="email" class="form-control input-sm textAlignRight" placeholder="כתובת מייל" name="sellerMail" required>
                  </div>
                </div>
              </fieldset>
